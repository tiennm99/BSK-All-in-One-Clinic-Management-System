...
public class SchoolUI {
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new JFrame("School UI");
        ...
        String[] sidebarItems = {"Dashboard", "Charts", "Report", "Message", "Staff", "Student", "Library", "Holiday", "Calendar", "Chat App", "Contact", "File Manager", "Our Centres", "Gallery"};
...
// Make the sidebar scrollable
        ...
        String[] cardTitles = {"New Student", "Income", "Expense", "Other Income"};
